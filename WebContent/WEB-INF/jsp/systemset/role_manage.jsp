...
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	<tr>
    	<td  width=100% height=30 align=left background = "images/m_table_top.jpg" colspan="6">
    		<strong>&nbsp;角色管理</strong>
				<a href="addrole"><input class="common_button" type="button" value="新增"></a>
    	</td>
    </tr>
	<tr>
...
<table id="data_list_table" class="data_list_table" cellSpacing=1 cellPadding=1>
	...
	<tr>
		...
		<td class="list_data_text">${Role.roleFlag }</td>
		
		<td class="list_data_op">
			<img onClick="to('role_update');" 
			                  title="编辑" 
			                  src="images/bt_edit.gif" 
			                  class="op_button" />
			<img onClick="to('${Role.roleId }/deleteR');"
							  title="删除" 
