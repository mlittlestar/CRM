...
<form action="addU" method="post" onsubmit="return check()">
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	<tr>
			<td  width=100% height=30 align=left background = "images/m_table_top.jpg" colspan="6"><strong>&nbsp;<a href="add">新建用户</a></strong></td>
    </tr>
	<tr>
		<th>用户编号</th>
		<td><input  type="text" name="usrId" value="${userId}"/></td>
		<th>用户名</th>
		<td>
	...
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	...
        	&nbsp;&nbsp;&nbsp;
			<a href="user_manage"><input class="common_button"  type="button" value="返回"></a>
&nbsp;&nbsp;
