...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<table id="data_list_table" class="data_list_table" cellSpacing=1
		...
		<c:forEach items="${productAll.list }" var="pro">
			<tr>
		...
		<tr>
			<th colspan="7" class="pager" align="right"
				...
				<div class="pager">
					第${productAll.pageNum }页
					 <a
						href="1/product">首页</a>

					<c:choose>
						<c:when test="${sessionScope.productAll.hasPreviousPage }">

							<a href="${sessionScope.productAll.prePage }/product">上一页</a>
						</c:when>
					</c:choose>
					...
					<c:choose>
						<c:when test="${sessionScope.productAll.hasNextPage }">

							<a href="${sessionScope.productAll.nextPage }/product">下一页</a>
						</c:when>
					</c:choose>
					...
					<a
						href="${sessionScope.productAll.navigateLastPage}/product">尾页</a>
				</div>
			</th>
		</tr>
	</table>
