...
<table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<table class="query_form_table" cellSpacing=1 cellPadding=1>
		...
		<tr>
			<td colspan="4" align="center"><a href="help"><input
				...
				<a href="linkman_add"><button class="common_button" type="button">新建</button></a>&nbsp;&nbsp;
				<a href="1/infolist"><input
	...
	<table class="data_list_table" cellSpacing=1 cellPadding=1>
		...
		<c:forEach items="${linkManByCstId}" var="linkman">
			...
			<tr>
				...
				<img
					onClick="to('linkman_edit');" title="编辑"
