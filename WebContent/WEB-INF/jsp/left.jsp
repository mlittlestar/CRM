		...
		<ul>
			...
			<li class="nav-item"><a href="javascript:;"><i
				...
				<ul>
					...
					<!--只有主管和高管才有销售机会管理   -->
					<li onclick="forward('1/salchance')"><a target="mainFrame"><span>销售机会管理</span></a></li>

					<!--只有经理和高管才有客户开发计划  -->
					<li onclick="forward('salplan')"><a  target="mainFrame"><span>客户开发计划</span></a></li>
				</ul></li>
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick="forward('1/infolist')"><a 
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick=""><a href="serviceadd"
						target="mainFrame"><span>服务创建</span></a></li>
					<li onclick="forward('1/servicedispatch')"><a
						target="mainFrame"><span>服务分配</span></a></li>
					<li onclick="forward('1/servicedeal')"><a 
						target="mainFrame"><span>服务处理</span></a></li>
					<li onclick=""><a href="serviceFeekback"
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick="forward('contr')"><a 
						target="mainFrame"><span>客户贡献分析</span></a></li>
					<li onclick="forward('cons')"><a 
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick="forward('1/product')"><a  target="mainFrame"><span>查询产品信息</span></a></li>
					<li onclick="forward('1/storage')"><a  target="mainFrame"><span>查询库存</span></a></li>
				</ul></li>
			...
			<li class="nav-item"><a href="javascript:;"><i
					...
					class="my-icon nav-more"></i></a>
				<ul>
					<li onclick="forward('role_manage')"><a 
						target="mainFrame"><span>角色管理</span></a></li>
					<li onclick="forward('1/user_manage')"><a 
						target="mainFrame"><span>用户管理</span></a></li>
					<li onclick="forward('1/log_review')"><a 
